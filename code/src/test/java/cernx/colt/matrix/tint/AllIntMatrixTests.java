package cernx.colt.matrix.tint;

import cernx.colt.matrix.tint.impl.SparseCCMIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.SparseRCIntMatrix2DViewTest;
import junit.framework.Test;
import junit.framework.TestSuite;
import cernx.colt.matrix.tint.impl.DenseColumnIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.DenseColumnIntMatrix2DViewTest;
import cernx.colt.matrix.tint.impl.DenseIntMatrix1DTest;
import cernx.colt.matrix.tint.impl.DenseIntMatrix1DViewTest;
import cernx.colt.matrix.tint.impl.DenseIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.DenseIntMatrix2DViewTest;
import cern.colt.matrix.tint.impl.DenseIntMatrix3DTest;
import cern.colt.matrix.tint.impl.DenseIntMatrix3DViewTest;
import cernx.colt.matrix.tint.impl.DenseLargeIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.DenseLargeIntMatrix2DViewTest;
...
import cernx.colt.matrix.tint.impl.DiagonalIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.DiagonalIntMatrix2DViewTest;
import cernx.colt.matrix.tint.impl.SparseCCIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.SparseCCIntMatrix2DViewTest;
import cernx.colt.matrix.tint.impl.SparseCCMIntMatrix2DViewTest;
import cernx.colt.matrix.tint.impl.SparseIntMatrix1DTest;
import cernx.colt.matrix.tint.impl.SparseIntMatrix1DViewTest;
import cernx.colt.matrix.tint.impl.SparseIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.SparseIntMatrix2DViewTest;
import cern.colt.matrix.tint.impl.SparseIntMatrix3DTest;
import cern.colt.matrix.tint.impl.SparseIntMatrix3DViewTest;
import cernx.colt.matrix.tint.impl.SparseRCIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.SparseRCMIntMatrix2DTest;
import cernx.colt.matrix.tint.impl.SparseRCMIntMatrix2DViewTest;
