...
/**
 * A comparison trait which imposes a <i>total ordering</i> on some
 ...
 */
@specialized
trait PrimitiveComparator[T] {

  type DoubleComparator = PrimitiveComparator[Double]
  type IntComparator = PrimitiveComparator[Int]
