 ...
 * DenseMatrix1D. However, constant factors are considerably
 * larger.
 *
...
*/
   ...
   */
  def like1D(size: Int): SparseHashMatrix1D[T] = new SparseHashMatrix1D[T](size)
