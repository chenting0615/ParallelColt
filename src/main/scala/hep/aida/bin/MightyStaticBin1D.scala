 ...
 */
@SerialVersionUID(1L)
class MightyStaticBin1D[@specialized T: Numeric](protected var hasSumOfLogarithmsVar: Boolean, protected var hasSumOfInversionsVar: Boolean, maxOrderForSumOfPowersVar: Int) extends StaticBin1D[T] {
