...
import cern.colt.matrix.impl.{DenseMatrix1D, StrideMatrix2D, DenseMatrix2D}

object CliTestMatrix2D {

//  type F = cern.jet.math.tdouble.DoubleFunctions
//
...
//    println(master)
//    master.assignConstant(1)
//    println("\n" + master)
//    master.viewPart(2, 1, 2, 3).assignConstant(2)
//    println("\n" + master)
//    val copyPart = master.viewPart(2, 1, 2, 3).copy()
//    copyPart.assignConstant(3)
//    copyPart.set(0, 0, 4)
//    println("\n" + copyPart)
//    println("\n" + master)
...
//  /**
//   */
//  def doubleTest(rows: Int, columns: Int, initialCapacity: Int, loadFactor: Double) {
//    val matrix = new SparseDoubleMatrix2D(rows, columns, initialCapacity, loadFactor)
//    println(matrix)
//    println("adding...")
//    var i = 0
...
//    matrix.assignConstant(F.plus(1))
...
//    println(matrix.assignConstant(F.random()))
//    println(matrix.assignConstant(new cern.jet.random.tdouble.Poisson(5, cern.jet.random.tdouble.Poisson.makeDefaultGenerator())))
//  }
//
//  /**
//   */
...
//    b = A.like1D(size).assignConstant(1)
...
//    val x = new DenseMatrix2D(size, size).assignConstant(0.5)
...
//    master.assignConstant(1)
//    println("\n" + master)
//    master.viewPart(2, 0, 2, 3).assignConstant(2)
//    println("\n" + master)
...
//    flip2.viewPart(0, 0, 2, 2).assignConstant(3)
...
//    println(master)
//    master.assignConstant(1)
//    val view = master.viewPart(2, 0, 2, 3).assignConstant(2)
//    println("\n" + master)
//    println("\n" + view)
...
//    val master = Factory2D.ascending(rows, columns)
//    println("\n" + master)
//    val view1 = master.viewTranspose()
//    println("view1=" + view1)
//    val view2 = view1.viewTranspose()
//    println("view2=" + view2)
//    view2.assign(-1)
//    println("master replaced" + master)
//    println("flip1 replaced" + view1)
...
//    val Hplus = DenseDoubleAlgebra.DEFAULT.inverse(H.viewTranspose().zMult(H, null))
