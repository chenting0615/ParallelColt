...
import cern.colt.function.FunctionTypes.IntDoubleFunction

abstract class StrideDoubleMatrix1DTest(arg0: String) extends TestCase(arg0) {
...
*/
  ...
  def testGetNonZerosIntArrayListDoubleArrayList() {
    ...
    val indexList = new IntArrayList()
    val valueList = new DoubleArrayList()
    A.forEachNonZero(new IntDoubleFunction() {
