...
import cern.colt.matrix.FormatterFactory;
 ...
 * requires the Colt distribution, whereas the rest of the package is entirely
 * stand-alone.
 */
public class DoubleConverter {
    ...
    String form(Formatter formatter, double value) {
    ...
    public String toString(DoubleIHistogram1D h) {
        ...
        Formatter f = new FormatterFactory().create(format);
        ...
        StrideMatrix2D heights = new DenseMatrix2D(1, h
                .xAxis().bins());
    ...
    public String toString(DoubleIHistogram2D h) {
        ...
        StrideMatrix2D heights = new DenseMatrix2D(
                toArrayHeights(h));
