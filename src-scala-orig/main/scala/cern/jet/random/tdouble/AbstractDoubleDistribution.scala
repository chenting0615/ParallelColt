 ...
 */
@SerialVersionUID(1L)
abstract class AbstractDoubleDistribution protected () extends cern.colt.PersistentObject with cern.colt.function.Function1[Double] with cern.colt.function.Function1[Int] {

  protected var randomGenerator: DoubleRandomEngine = null
   ...
   */
  def apply(dummy: Double): Double = nextDouble()
