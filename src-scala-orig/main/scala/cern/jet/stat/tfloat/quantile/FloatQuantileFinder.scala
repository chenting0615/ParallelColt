 ...
 */
trait FloatQuantileFinder extends java.io.Serializable {
   ...
   */
  def addAllOf(values: cern.colt.list.tfloat.FloatArrayList): Unit
   ...
   */
  def addAllOfFromTo(values: FloatArrayList, from: Int, to: Int): Unit
