 ...
 */
@SerialVersionUID(1L)
class SelectedSparseIntMatrix2D protected (rows: Int, 
    columns: Int, 
   ...
   * @param offset
   */
  protected def this(elements: AbstractLongIntMap, 
  ...
  def viewColumn(column: Int): IntMatrix1D = {
    ...
    new SelectedSparseIntMatrix1D(viewSize, this.elements, viewZero, viewStride, viewOffsets, viewOffset)
  }
  ...
  protected def viewSelectionLike(rowOffsets: Array[Int], columnOffsets: Array[Int]): IntMatrix2D = {
    new SelectedSparseIntMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset)
  }
}
