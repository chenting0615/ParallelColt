 ...
 */
@SerialVersionUID(1L)
class SelectedDenseColumnIntMatrix2D protected (rows: Int, 
    columns: Int, 
    protected var elements: Array[Int], 
    rowZero: Int, 
    columnZero: Int, 
    rowStride: Int, 
    columnStride: Int, 
    ...
    protected var offset: Int) extends IntMatrix2D {
   ...
   * @param offset
   */
  protected def this(elements: Array[Int], 
  ...
  def viewColumn(column: Int): IntMatrix1D = {
    ...
    new SelectedDenseIntMatrix1D(viewSize, this.elements, viewZero, viewStride, viewOffsets, viewOffset)
  }
  ...
  protected def viewSelectionLike(rowOffsets: Array[Int], columnOffsets: Array[Int]): IntMatrix2D = {
    new SelectedDenseColumnIntMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset)
  }
}
