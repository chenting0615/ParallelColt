 ...
 */
@SerialVersionUID(1L)
class SelectedDenseIntMatrix3D protected (protected var elements: Array[Int], 
  ...
  def viewColumn(column: Int): IntMatrix2D = {
    ...
    new SelectedDenseIntMatrix2D(viewRows, viewColumns, this.elements, viewRowZero, viewColumnZero, viewRowStride, 
      viewColumnStride, viewRowOffsets, viewColumnOffsets, viewOffset)
  }
  ...
  protected def viewSelectionLike(sliceOffsets: Array[Int], rowOffsets: Array[Int], columnOffsets: Array[Int]): IntMatrix3D = {
    new SelectedDenseIntMatrix3D(this.elements, sliceOffsets, rowOffsets, columnOffsets, this.offset)
  }
}
