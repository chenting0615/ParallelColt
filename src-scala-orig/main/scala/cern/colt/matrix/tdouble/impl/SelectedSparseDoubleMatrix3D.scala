 ...
 */
@SerialVersionUID(1L)
class SelectedSparseDoubleMatrix3D protected (protected var elements: AbstractLongDoubleMap,
  ...
  protected def viewSelectionLike(sliceOffsets: Array[Int], rowOffsets: Array[Int], columnOffsets: Array[Int]): DoubleMatrix3D = {
    new SelectedSparseDoubleMatrix3D(this.elements, sliceOffsets, rowOffsets, columnOffsets, this.offset)
  }
}
